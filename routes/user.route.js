...
const { signup, login, updateImage, forgotPassword, resetPassword, fetchImage } = require('../controller/user.controller')
...
router.get('/profile-picture', AuthMiddleware, fetchImage)
